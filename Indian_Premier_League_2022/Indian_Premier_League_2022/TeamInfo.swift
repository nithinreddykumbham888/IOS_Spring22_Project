...
struct teamInfo{
    ...
    let valuation : Double
        ...
        let team4 =  teamInfo(captain: "Hardik Pandya", coach: "Ashish Nehra",owner: "CVC Capital Patners", homeGround: "Narendra Modi Stadium", valuation: 740.00)
        ...
        let team8 =  teamInfo(captain: "Kane Williamson", coach: "Trevor Bayliss",owner: "Sun TV Network", homeGround: "Rajiv Gandhi Stadium", valuation: 52.00)
        ...
        let team10 =  teamInfo(captain: "Mayank Agarwal", coach: "Anil Kumble",owner: "Punjab Cricket Association", homeGround: "Inderjit Singh Bindra", valuation: 36.00)
